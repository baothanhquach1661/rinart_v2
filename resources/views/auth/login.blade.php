                ...
                <div class="col-12">
                    <div class="breadcrumb__content text-center">
                        <div class="breadcrumb__title-wrapper mb-15 mb-sm-10 mb-xs-5">
                            <h1 class="breadcrumb__title color-white wow fadeIn animated" data-wow-delay=".1s">Đăng Nhập</h1>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="all-content">
                            ...
                            <div class="signup-form-wrapper">
                                <div class="item-thumb">
                                    ...
                                    <div class="signup-item">
                                        ...
                                        <x-input-error :messages="$errors->get('email')" class="mb-2 text-danger" />
                                    </div>
                                    <div class="signup-action">
                                        <div class="course-sidebar-list">
                                            <input class="signup-checkbo" type="checkbox" id="sing-in">
                                            <label class="sign-check" for="sing-in"><span>Ghi nhớ đăng nhập</span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="button">
                                    <div class="mb-20">
                                        <button type="submit" class="signin-buttom">Sign In</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="button-wrap d-flex ">
                            <div class="sign-facebook mb-sm-30 mb-xs-30">
                                <a href="#">
