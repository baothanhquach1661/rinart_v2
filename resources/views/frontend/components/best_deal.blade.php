    ...
    <div class="container">
        <div class="blog-top heading-space2">
            <div class="best-deal__title-wrapper">
                <h6 class="best-deal__title-wrapper-subtitle">Best Deal</h6>
                <h2 class="best-deal__title-wrapper-title">Best Deals Product</h2>
            </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-12 col-md-6 col-sm-6 mb-25">
                <div class="best-deal__active-content overflow-hidden">
                    <div class="right ml-30 mb-lg-30">
                        <h4 class="best-deal__active-content-title">Hot Deals</h4>
                        <p class="best-deal__active-content-description">Pair text with an image to focus on your chosen product, collection, or blog post.</p>
                    ...
                    <div class="best-deal__active-content-bottom-img">
                        <img class="upDown" src="{{ asset('frontend/assets/imgs/home-3-best-deal/home-3-best-deal-bottom-img.png')}}" alt="img not found">
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="rr-fea-product__item rr-pro-img">
                    ...
                    <div class="rr-fea-product__thumb fix p-relative">
                        <img  src="{{ asset('frontend/assets/imgs/prodact/prodact-card-3.png')}}"  alt="img not found">
                    ...
                    <div class="rr-fea-product__content">
                        ...
                        <h4 class="rr-fea-product__title-sm"><a href="shop.html">Paper Cups Coffee</a></h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="rr-fea-product__item rr-pro-img">
                    ...
                    <div class="rr-fea-product__thumb fix p-relative">
                        <img  src="{{ asset('frontend/assets/imgs/prodact/prodact-card-1.png')}}"  alt="img not found">
                        <div class="rr-fea-product__thumb-text">
                            <span>-60%</span>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="rr-fea-product__item rr-pro-img">
                    ...
                    <div class="rr-fea-product__thumb fix p-relative">
                        <img  src="{{ asset('frontend/assets/imgs/prodact/prodact-card-2.png')}}"  alt="img not found">
                        <div class="rr-fea-product__thumb-text">
                            <span>-70%</span>
                        </div>
