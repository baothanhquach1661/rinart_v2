            ...
            <div class="header-element header-fullscreen">
                ...
                <a aria-label="anchor" onclick="openFullscreen();" href="javascript:void(0);" class="header-link">
                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" class="full-screen-open header-link-icon">
                        <path d="M8.5,21H3v-5.5C3,15.223877,2.776123,15,2.5,15S2,15.223877,2,15.5v6.0005493C2.0001831,21.7765503,2.223999,22.0001831,2.5,22h6C8.776123,22,9,21.776123,9,21.5S8.776123,21,8.5,21z M8.5,2H2.4993896C2.2234497,2.0001831,1.9998169,2.223999,2,2.5v6.0005493C2.0001831,8.7765503,2.223999,9.0001831,2.5,9h0.0006104C2.7765503,8.9998169,3.0001831,8.776001,3,8.5V3h5.5C8.776123,3,9,2.776123,9,2.5S8.776123,2,8.5,2z M21.5,15c-0.276123,0-0.5,0.223877-0.5,0.5V21h-5.5c-0.276123,0-0.5,0.223877-0.5,0.5s0.223877,0.5,0.5,0.5h6.0006104C21.7765503,21.9998169,22.0001831,21.776001,22,21.5v-6C22,15.223877,21.776123,15,21.5,15z M21.5,2h-6C15.223877,2,15,2.223877,15,2.5S15.223877,3,15.5,3H21v5.5005493C21.0001831,8.7765503,21.223999,9.0001831,21.5,9h0.0006104C21.7765503,8.9998169,22.0001831,8.776001,22,8.5V2.4993896C21.9998169,2.2234497,21.776001,1.9998169,21.5,2z"></path>
                    </svg>
                </a>
                <!-- End::header-link -->
            </div>
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0);"><span class="badge bg-secondary-transparent" id="notification-data">4 Notifications</span></a>
                        </div>
                    </div>
                    <div class="dropdown-divider"></div>
                    <ul class="list-unstyled mb-0" id="header-notification-scroll">
                        <li class="dropdown-item p-3 border-bottom">
                            <div class="d-flex align-items-start">
                                 ...
                                 <div class=" d-flex flex-fill align-items-center justify-content-between">
                                    <div class="flex-grow-1">
                                        <p class="mb-0"><a href="mail-inbox.html" class="text-gray">New Message Received</a></p>
                                        <p class="text-muted fw-normal fs-12 header-notification-text mb-0">2 hours ago</p>
                                    </div>
                                    <div>
                        ...
                        <li class="dropdown-item p-3 border-bottom">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="d-flex flex-fill align-items-center justify-content-between">
                                    <div class="flex-grow-1">
                                        <p class="mb-0"><a href="mail-inbox.html" class="text-gray">New Order Received</a></p>
                                        <p class="text-muted fw-normal fs-12 header-notification-text mb-0">1 day ago</p>
                                    </div>
                                    <div>
                                        <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-muted me-1 dropdown-item-close1"><i class="ti ti-x fs-16"></i></a>
                                    </div>
                    ...
                    <div class="dropdown-footer empty-header-item1">
                        <a href="mail-inbox.html"  class="dropdown-footer btn btn-primary my-0">View All Notifications</a>
                    </div>
