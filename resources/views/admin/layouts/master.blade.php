...
<head>
    ...
    <title> Rinart &amp; Admin Dashboard</title>
    <meta name="Description" content="Bootstrap Responsive Admin Web Dashboard HTML5 Template">
    <meta name="Author" content="Spruko Technologies Private Limited">
	<meta name="keywords" content="admin dashboard,admin ">
    ...
    <link rel="stylesheet" href="{{ asset('backend/assets/libs/quill/quill.bubble.css')}}">
