    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <h1 class="page-title fw-semibold fs-20 mb-0">Editing {{ $blog->title }}</h1>
            ...
            <!-- Row -->
            <div class="row">
                <form action="{{ route('admin.blog.update', $blog->id) }}" method="POST" class="row g-3 needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="file" class="form-control" name="mage" id="image_input">
                                        <div id="image_preview" class="mt-3">
                                            <img id="image" src="{{ asset($blog->image) }}" alt="{{ $blog->title }}" style="height: 150px; max-width: 100%;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div id="banner_image_preview" class="mt-3">
                                            <img id="banner_image" src="{{ asset($blog->banner) }}" alt="{{ $blog->title }}" style="height: 150px; max-width: 100%;">
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="js-example-basic-single main-category" name="blog_category_id">
                                        ...
                                        @foreach ($b_categories as $b_category)
                                            <option {{ $b_category->id == $blog->blog_category_id ? 'selected' : ''  }}
                                                value="{{ $b_category->id }}">{{ $b_category->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
